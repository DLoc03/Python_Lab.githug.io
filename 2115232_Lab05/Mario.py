...
cactus_img = pygame.image.load('cactus_brick.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('cactus_brick.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('fire_brick.png')
